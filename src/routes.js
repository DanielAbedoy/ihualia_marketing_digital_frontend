...
const routes_ini = [
  ...
  { path: '/encuestas', exact:true, name:'Encuentas', component: Encuestas},
...
const routes =  [...routes_ini, ...routes_contactos,...routes_cuentas,...routes_usuarios_admin, ...routes_eventos,...routes_email, ...routes_encuentas];
