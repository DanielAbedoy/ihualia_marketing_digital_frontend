    ...
    <div className="opps">
			<div className="opps-header">
				...
				<div className="opps-reference">
					<h3>Referencia</h3>
					<p className="p-h1 h1">{props.referencia}</p>
				</div>
			</div>
			<Row>
					<Col md="5" xs="5" className="mx-auto p-0 mt-1">
						<img width="100%" src={props.barcode} alt="OXXOPay" />
				</Col>
				</Row>
			<div className="opps-instructions">
				...
				<div className="opps-footnote">Al completar estos pasos recibirás un correo de <strong>{props.organizador}</strong> confirmando tu pago.</div>
			</div>
		</div>
  );
}
